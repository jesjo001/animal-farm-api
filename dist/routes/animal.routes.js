...
router.post('/', (0, auth_middleware_1.authorize)('tenant_admin', 'manager'), (0, planEnforcement_middleware_1.checkPlanEnforcement)('animals'), animal_controller_1.createAnimal);
